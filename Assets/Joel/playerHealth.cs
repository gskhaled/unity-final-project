...
public class playerHealth : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(1).IsName("pick_up"))
        {
        ...
        if (animator.GetCurrentAnimatorStateInfo(1).IsName("hit_Reacion"))
        {
            animator.SetBool("hit", false);
        }
        if (animator.GetCurrentAnimatorStateInfo(2).IsName("pin_Down"))
        {
